    ...
    <div
      ...
      <div className="px-4 py-10 md:py-20">
        ...
        <motion.p
          ...
          Deliver instant, accurate medical assistance through neutral voice conversation.
          Automate appointments scheduing symptom triage, and follow-up care-24/7
        </motion.p>
      <Link href={'sign-in'}>
        <motion.div
          initial={{
...
const Navbar = () => {
  ...
  return (
    <nav
      ...
      <div    div className="flex gap-5 item-center">
           <UserButton/>
            <button className="bg-black text-white px-4 py-2 rounded-lg"> Dasboard </button>
           </div>
